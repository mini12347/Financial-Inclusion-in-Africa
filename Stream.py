...
if page == "Dashboard":
    ...
    st.markdown("Explore interactive charts about bank account ownership in the dataset.")
    ...
    with col1:
        ...
        fig1 = px.bar(data.groupby('location_type')['bank_account'].mean().reset_index(),
    ...
    with col2:
        st.subheader("Bank Account Ownership by Gender")
        fig2 = px.bar(data.groupby('gender_of_respondent')['bank_account'].mean().reset_index(),
